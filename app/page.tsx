...
const content = {
  en: {
    ...
    explore: "Explore", continue: "Continue", focus: ["Mobileye", "ECI Telecom", "EMC²", "Dell", "Independent products"],
    aboutTitle: <>Build it right.<br />Then make it <span className="accent">better.</span></>,
    about: "I'm Yehonatan Arad, a software developer with experience across independent product work and large technology organizations, including Mobileye, ECI Telecom, EMC², and Dell. I enjoy shaping useful products, solving hard problems, and turning good ideas into reliable software.",
  ...
  he: {
    ...
    explore: "היכרות", continue: "המשך", focus: ["Mobileye", "ECI Telecom", "EMC²", "Dell", "מוצרים עצמאיים"],
    aboutTitle: <>בונים נכון.<br />ואז עושים את זה <span className="accent">טוב יותר.</span></>,
    about: "אני יהונתן ארד, מפתח תוכנה עם ניסיון בעבודה עצמאית ובחברות טכנולוגיה גדולות, בהן Mobileye, ECI Telecom, EMC² ו־Dell. אני נהנה לבנות מוצרים שימושיים, לפתור בעיות מורכבות, ולהפוך רעיונות טובים לתוכנה אמינה.",
